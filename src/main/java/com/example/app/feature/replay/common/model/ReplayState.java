...
public class ReplayState {
     ...
     *
     * <p>
     * key は vdu1 / vdu2 / vdu3 / vdu4 /
     * alert1 / alert2 / alertElectrical を想定します。
     * </p>
     */
    private Map<String, Map<String, Integer>> eventSeries = new LinkedHashMap<String, Map<String, Integer>>();

    /** event 系で最後に取り込んだ bucket_start */
    private LocalDateTime eventLastLoadedBucketStart;
    ...
    public LocalDateTime getEventLastLoadedBucketStart() { return eventLastLoadedBucketStart; }
    public void setEventLastLoadedBucketStart(LocalDateTime eventLastLoadedBucketStart) {
        this.eventLastLoadedBucketStart = eventLastLoadedBucketStart;
    }
