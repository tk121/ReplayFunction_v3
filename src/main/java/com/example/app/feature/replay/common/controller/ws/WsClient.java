...
public class WsClient {
	 ...
	 * @param vduNo VDU番号
	 */
    public WsClient(Session session, String roomId, String clientType, int vduNo, String clientId, String userId) {
    ...
    public int getVduNo() { return vduNo; }
    public String getClientId() { return clientId; }
    public String getUserId() { return userId; }
    public boolean isControl() { return CLIENT_TYPE_CONTROL.equals(clientType); }
    public boolean isVdu() { return CLIENT_TYPE_VDU.equals(clientType); }
    public boolean isAvdu() { return CLIENT_TYPE_AVDU.equals(clientType); }
}
